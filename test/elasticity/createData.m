...
for p=1:55
    ...
    if abs(xError)<0.1 && abs(yError)<0.1
        ...
        for E=[2500 5000 10000 20000 40000]
            trac=zeros(S,S,2);
            ...
            %f=2000/prctile(tracmagInterior,99.9);
            f=6000/max(tracmagInterior);
            trac(:,:,1)=trac(:,:,1)*f;
            trac(:,:,2)=trac(:,:,2)*f;
            ...
            fn1 = sprintf('testData/trac/MLData%04d.mat',p);
            fn2 = sprintf('testData/dspl/MLData%04d-%d.mat',p,E);
